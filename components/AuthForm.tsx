      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        {type === "sign-up" && (
         ...
         <CustomInput control={form.control} name="firstName" label="First Name" placeholder="Enter your first name" />
              ...
              <div className='flex gap-4'>
              <CustomInput control={form.control} name="state" label="State" placeholder="Example Paris" />
              <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="Example: 75260" />
              </div>
              <div className='flex gap-4'>
